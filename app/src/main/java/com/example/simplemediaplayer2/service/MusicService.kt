...
class MusicService : MediaBrowserServiceCompat() {
    ...
    private fun setupPlayerAdapter() {
        ...
        playback = MusicPlayerAdapter(context = this, playbackStateChange = playbackStateChange)
    }
    ...
    private inner class MusicSessionCallback : MediaSessionCompat.Callback() {
        ...
        override fun onPrepare() {
            ...
            prepareMusicMetadata =
                MusicLibrary.getMusicMetadata(this@MusicService, musicId)
        ...
        override fun onSkipToNext() {
            super.onSkipToNext()
            playedItemIndex = if (playedItemIndex < playList.size - 1) {
                playedItemIndex + 1
            } else {
                0
            }
